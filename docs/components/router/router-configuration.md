...
AgentAware routing is an experimental program-aware admission and placement policy for sequential agent workloads. See [AgentAware Routing](agent-aware-routing.md) for configuration, scheduling behavior, and lifecycle requirements.
